  ...
  {/* Card 1 - GOLD */}
        <div className="w-[100%] md:[60%] lg:w-[240px] h-[142px] rounded-2xl bg-white shadow-md flex justify-between " style={{padding:'18px'}}>
          <div className="flex flex-col justify-between">
            ...
            <div className="text-[16px] text-green-500 text-justify font-medium">
              <span className="block">+55%</span>
              <span className="text-gray-500 font-normal block">since yesterday</span>
            </div>
          </div>
